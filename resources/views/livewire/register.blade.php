<form method="POST" wire:submit.prevent="register">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" wire:model="name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                    ...
                    <div class='mt-3' >
                        <small class='fs-3' >Already have a account?</small>
